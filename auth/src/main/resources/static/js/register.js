...
function check_password(password) {
	...
	if(password.indexOf(" ") != -1){
		...
		document.getElementById('password_notice').innerHTML = "登录密码只能为数字或者字母";
		document.getElementById('password_notice').style.color = "#E31939";
		$("#pwd_notice").show();
		$("#pwd_intensity").hide();
		document.getElementById('btn_submit').disabled="true";
	...
	if(document.getElementById('btn_submit').disabled){
...
//			document.getElementById('mobile_phone_notice').innerHTML = msg_can_rg;
			document.getElementById('mobile_phone_notice').innerHTML = "<img src='images/denglu-icon.png'>";
