...
!function (window, $, undefined) {
    ...
    var SVGMap = function () {
            ...
            return SVGMap.prototype.options = {
                ...
                mapWidth: 820,
                mapHeight: 650,
                stateColorList: ["#006835", "#23ac38", "#60b482", "#7bc6a5", "#90c320", "#0ba29b", "#EDF2F6"],
                ...
                strokeWidth: 1,
                strokeColor: "#F9FCFE",
                stateInitColor: "#23ac38",
                stateHoverColor: "#7bc6a5",
                stateSelectedColor: "#0ba29b",
                ...
                mapTipHtml: function (a, b) {
					var vhtml ='<div><a href="' + b.href + '"><span class="h1">'+ b.name + b.techan +'</span>';
					//vhtml += '<img src="' + b.img + '"/>';
                    return vhtml;
                },
                ...
                for (var state in mapConfig.shapes) {
                    ...
                    var obj = r.path(mapConfig.shapes[state]);
						...
						obj.img = mapConfig.img[state], 
						//obj.href = mapConfig.href[state],
						obj.href = "javascript:void(0)"
						obj.techan = mapConfig.techan[state],
						obj.timer = "", obj.attr(attributes), opt.external && (self.externalData[obj.id] = obj), stateData[state] && stateData[state].diabled ? obj.attr({
                        fill: disabledColor,
                        cursor: "default"
                    }) : (obj.attr({
                        fill: initColor
